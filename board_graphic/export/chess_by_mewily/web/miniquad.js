...
var clipboard = null,
    wasm_memory, animation_frame_timeout, FS, GL, Module, wasm_exports, emscripten_shaders_hack, importObject, ctx, js_objects, unique_js_id, quad_socket, connected, received_buffer, uid, ongoing_requests, plugins = [],
    high_dpi = !1,
...
acquireVertexArrayObjectExtension(gl), acquireInstancedArraysExtension(gl), acquireDisjointTimerQueryExtension(gl), acquireDrawBuffers(gl), gl.getExtension("WEBGL_depth_texture") == null && alert("Cant initialize WEBGL_depth_texture extension");
...
function UTF8ToString(e, t) {
    ...
    for (var n, a, r, c, s = 0, l = s + t, o = ""; !(s >= l);) {
        ...
        r = i[s++] & 63, (n & 240) == 224 ? n = (n & 15) << 12 | a << 6 | r : ((n & 248) != 240 && console.warn("Invalid UTF-8 leading byte 0x" + n.toString(16) + " encountered when deserializing a UTF-8 string on the asm.js/wasm heap to a JS string!"), n = (n & 7) << 18 | a << 12 | r << 6 | i[s++] & 63), n < 65536 ? o += String.fromCharCode(n) : (c = n - 65536, o += String.fromCharCode(55296 | c >> 10, 56320 | c & 1023))
    }
    return o
}
...
function stringToUTF8(e, t, n, s) {
    for (var o, r, c = n, i = n + s, a = 0; a < e.length; ++a)
        ...
        if (n + 3 >= i) break;
        o >= 2097152 && console.warn("Invalid Unicode code point 0x" + o.toString(16) + " encountered when serializing a JS string to an UTF-8 string on the asm.js/wasm heap! (Valid unicode code points should be in range 0-0x1FFFFF)."), t[n++] = 240 | o >> 18, t[n++] = 128 | o >> 12 & 63, t[n++] = 128 | o >> 6 & 63, t[n++] = 128 | o & 63
    }
    return n - c
}
FS = {
...
function _glGenObject(e, t, n, s, o) {
    for (var i, a, r = 0; r < e; r++) i = gl[n](), a = i && GL.getNewId(s), i ? (i.name = a, s[a] = i) : (console.error("GL_INVALID_OPERATION"), GL.recordError(1282), alert("GL_INVALID_OPERATION in " + o + ": GLctx." + n + " returned null - most likely GL context is lost!")), getArray(t + r * 4, Int32Array, 1)[0] = a
}
...
function _webglGet(e, t, n) {
    ...
    if (o === void 0) switch (s = gl.getParameter(e), typeof s) {
        case "number":
            o = s;
            break;
        case "boolean":
...
emscripten_shaders_hack = !1, importObject = {
    env: {
        ...
        glGetUniformLocation: function(e, t) {
            ...
            var s, o, n = 0;
            return t[t.length - 1] == "]" && (s = t.lastIndexOf("["), n = t[s + 1] != "]" ? parseInt(t.slice(s + 1)) : 0, t = t.slice(0, s)), o = GL.programInfos[e] && GL.programInfos[e].uniforms[t], o && n >= 0 && n < o[0] ? o[1] + n : -1
        },
        ...
        glShaderSource: function(e, t, n, s) {
            ...
            emscripten_shaders_hack && (o = o.replace(/#extension GL_OES_standard_derivatives : enable/g, ""), o = o.replace(/#extension GL_EXT_shader_texture_lod : enable/g, ""), i = "", o.indexOf("gl_FragColor") != -1 && (i += `out mediump vec4 GL_FragColor;
...
` + i)), gl.shaderSource(GL.shaders[e], o)
        },
        ...
        glGetShaderiv: function(e, t, n) {
            ...
            } else t == 35720 ? (s = gl.getShaderSource(GL.shaders[e]), i = s === null || s.length == 0 ? 0 : s.length + 1, getArray(n, Int32Array, 1)[0] = i) : getArray(n, Int32Array, 1)[0] = gl.getShaderParameter(GL.shaders[e], t)
        },
        ...
        run_animation_loop: function(e) {
            canvas.onmousemove = function(e) {
                ...
                n = 0, e.ctrlKey && (n |= SAPP_MODIFIER_CTRL), e.shiftKey && (n |= SAPP_MODIFIER_SHIFT), e.altKey && (n |= SAPP_MODIFIER_ALT), wasm_exports.key_down(t, n, e.repeat), (t == 32 || t == 39 || t == 47) && wasm_exports.key_press(t)
                ...
                var n, s, o, i = e.clipboardData || window.clipboardData,
                    t = i.getData("Text");
                t != null && t.length != 0 && (n = (new TextEncoder).encode(t).length, s = wasm_exports.allocate_vec_u8(n), o = new Uint8Array(wasm_memory.buffer, s, n), stringToUTF8(t, o, 0, n), wasm_exports.on_clipboard_paste(s, n))
        ...
        fs_load_file: function(e, t) {
            var s, o = UTF8ToString(e, t),
                n = FS.unique_id;
            return FS.unique_id += 1, s = new XMLHttpRequest, s.open("GET", o, !0), s.responseType = "arraybuffer", s.onreadystatechange = function() {
...
function add_missing_functions_stabs(e) {
    ...
    for (const e in t) importObject.env[t[e].name] == void 0 && (console.warn("No " + t[e].name + " function in gl.js"), importObject.env[t[e].name] = function() {
...
function load(e) {
    var t = fetch(e);
    register_plugins(plugins), typeof WebAssembly.compileStreaming == "function" ? WebAssembly.compileStreaming(t).then(e => (add_missing_functions_stabs(e), WebAssembly.instantiate(e, importObject))).then(e => {
...
let audio_context, sounds = new Map,
    playbacks = [],
    sound_key_next = 1,
    playback_key_next = 1;
    ...
    if (audio_context == null) {
        ...
        let t = audio_context.listener;
        {
            ...
            var e = function() {
                ...
                s.buffer = o, s.connect(t.destination), s.start ? s.start(0) : s.play ? s.play(0) : s.noteOn && s.noteOn(0), document.removeEventListener("touchstart", e), document.removeEventListener("touchend", e), document.removeEventListener("mousedown", e), document.removeEventListener("keydown", e)
            };
            document.addEventListener("touchstart", e), document.addEventListener("touchend", e), document.addEventListener("mousedown", e), document.addEventListener("keydown", e)
        }
    }
}
...
function audio_add_buffer(e, t) {
    let s = wasm_memory.buffer.slice(e, e + t),
        n = sound_key_next;
    return sound_key_next += 1, audio_context.decodeAudioData(s, function(e) {
        sounds.set(n, e)
    }, function(e) {
...
function audio_play_buffer(e, t, n) {
    let o = playback_key_next++,
        s = recycle_playback();
    s.sound_key = e, s.playback_key = o, s.source.connect(s.gain_node), s.gain_node.connect(audio_context.destination), s.gain_node.gain.value = t, s.source.loop = n, s.ended = function() {
        stop(s)
...
"use strict";
ctx = null, js_objects = {}, js_objects[-1] = null, js_objects[-2] = void 0, unique_js_id = 0, register_plugin = function(e) {
    e.env.js_create_string = function(e, t) {
        ...
        for (var i = js_objects[e], o = toUTF8Array(i), a = o.length, r = new Uint8Array(wasm_memory.buffer, t, n), s = 0; s < a; s++) r[s] = o[s]
    }, e.env.js_unwrap_to_buf = function(e, t, n) {
        for (var o = js_objects[e], i = o.length, a = new Uint8Array(wasm_memory.buffer, t, n), s = 0; s < i; s++) a[s] = o[s]
...
function toUTF8Array(e) {
    for (var t, n = [], s = 0; s < e.length; s++) t = e.charCodeAt(s), t < 128 ? n.push(t) : t < 2048 ? n.push(192 | t >> 6, 128 | t & 63) : t < 55296 || t >= 57344 ? n.push(224 | t >> 12, 128 | t >> 6 & 63, 128 | t & 63) : (s++, t = 65536 + ((t & 1023) << 10 | e.charCodeAt(s) & 1023), n.push(240 | t >> 18, 128 | t >> 12 & 63, 128 | t >> 6 & 63, 128 | t & 63));
    return n
}
...
register_plugin = function(e) {
    e.env.ws_connect = ws_connect, e.env.ws_is_connected = ws_is_connected, e.env.ws_send = ws_send, e.env.ws_try_recv = ws_try_recv, e.env.http_make_request = http_make_request, e.env.http_try_recv = http_try_recv
}, miniquad_add_plugin({
    register_plugin,
    on_init,
    version: "0.1.1",
...
function ws_connect(e) {
    quad_socket = new WebSocket(consume_js_object(e)), quad_socket.binaryType = "arraybuffer", quad_socket.onopen = function() {
        connected = 1
    }, quad_socket.onmessage = function(e) {
        if (typeof e.data == "string") received_buffer.push({
            text: 1,
            data: e.data
        });
        else {
...
function http_make_request(e, t, n, s) {
    var o, i, a, c, l, r = uid;
    uid += 1, e == 0 && (i = "POST"), e == 1 && (i = "PUT"), e == 2 && (i = "GET"), e == 3 && (i = "DELETE"), c = consume_js_object(t), l = consume_js_object(n), a = consume_js_object(s), o = new XMLHttpRequest, o.open(i, c, !0), o.responseType = "arraybuffer";
